    ...
    <div class="container" style="overflow:hidden;">
		<div class="row" style="height:150px;">
			...
			<div class="col-md-10"
				...
				<h3>
					<label class="label label-success">&nbsp;徐州工程学院校园失物招领个人管理中心&nbsp;</label>
				</h3>
			</div>
			<div class="col-md-1"></div>
		</div>
			...
			<div class="col-md-10">
				<div class="well well-sm">
					<ul class="nav nav-pills webdirection" >
					    ...
					    <li role="presentation"><a href="User/MyInfo.jsp" target="content"><span class="glyphicon glyphicon-user"></span>&nbsp;个人信息管理</a></li>
						<li role="presentation"><a href="User/MyPublishing.jsp" target="content"><span class="glyphicon glyphicon-bookmark"></span>&nbsp;我的丢失</a></li>
						<!-- 						<li role="presentation"><a href="User/MyFinding.jsp" target="content"><span class="glyphicon glyphicon-bookmark"></span>&nbsp;我的捡拾</a></li>
						 -->
						<li role="presentation"><a href="User/MyClaim.jsp" target="content"><span class="glyphicon glyphicon-tag"></span>&nbsp;我的认领</a></li>
					</ul>
				</div>
				<div class="panel panel-default">
					<div class="panel-body" style="height:800px;">
						<iframe src="User/MyInfo.jsp" width="100%" height="100%" border="none"
